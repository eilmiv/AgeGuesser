...
export function generateId() {
  ...
  // Fallback for environments with getRandomValues but no randomUUID (e.g., older browsers on http)
  ...
  throw new Error(
    "No cryptographic random source available. Use a secure context (https) or upgrade your environment."
  );
}
